...
{
    public class FragmentDistributionRequestedEventTests
    {
        private readonly ITestOutputHelper Output;
        private readonly FragmentDistributionRequestedEvent Example;
        ...
        public FragmentDistributionRequestedEventTests(ITestOutputHelper output)
        {
            Output = output;
            Example = new FragmentDistributionRequestedEvent(
        ...
        {
            FragmentDistributionRequestedEvent fragmentDistributionRequestedEvent = FragmentDistributionRequestedEvent.FromJsonString(JsonString_WithJsonSerializerOptions_WithIgnoreNullValues, SerializationTests.JsonSerializerOptions_WithIgnoreNullValues);

            Assert.Equal(Example.EventId, fragmentDistributionRequestedEvent.EventId);
            Assert.Equal(Example.Hash, fragmentDistributionRequestedEvent.Hash);
        }

        [Fact]
        public void FromJsonString_Should_DeserializeJsonStringCorrectly_WithJsonSerializerOptions_WithoutIgnoreNullValues()
        {
            FragmentDistributionRequestedEvent fragmentDistributionRequestedEvent = FragmentDistributionRequestedEvent.FromJsonString(JsonString_WithJsonSerializerOptions_WithoutIgnoreNullValues, SerializationTests.JsonSerializerOptions_WithoutIgnoreNullValues);
