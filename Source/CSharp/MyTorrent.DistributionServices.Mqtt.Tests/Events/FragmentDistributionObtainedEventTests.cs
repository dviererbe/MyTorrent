...
{
    public class FragmentDistributionObtainedEventTests
    {
        private readonly ITestOutputHelper Output;
        private readonly FragmentDistributionObtainedEvent Example;
        ...
        public FragmentDistributionObtainedEventTests(ITestOutputHelper output)
        {
            Output = output;
            Example = new FragmentDistributionObtainedEvent(
        ...
        {
            FragmentDistributionObtainedEvent fragmentDistributionFailedEvent = FragmentDistributionObtainedEvent.FromJsonString(JsonString_WithJsonSerializerOptions_WithIgnoreNullValues, SerializationTests.JsonSerializerOptions_WithIgnoreNullValues);
        ...
        {
            FragmentDistributionObtainedEvent fragmentDistributionFailedEvent = FragmentDistributionObtainedEvent.FromJsonString(JsonString_WithJsonSerializerOptions_WithoutIgnoreNullValues, SerializationTests.JsonSerializerOptions_WithoutIgnoreNullValues);
